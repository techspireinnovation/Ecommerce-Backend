...
class StoreRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'weight_from.required' => 'Minimum weight is required.',
            'weight_from.numeric' => 'Minimum weight must be a valid number.',
            'weight_from.min' => 'Minimum weight cannot be negative.',
